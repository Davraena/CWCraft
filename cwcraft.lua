...
local CRAFTS = {
    ...
    },
    {
        ...
        recipes = {
            ...
            { 77, 'Clothespole',          'Mahogany Lumber, Silk Thread',   '' },
            { 81, 'Cabinet',              'Holly Lumber, Oak Lumber x4',    '' },
            { 87, 'Mithran Fishing Rod',  'Rattan Lumber, Rainbow Thread',  '' },
            { 88, 'Half Partition',       'Mahogany Lumber x6',             '' },
            { 94, 'Eight-Sided Pole',     'Walnut Lumber x2, Mythril Ingot', 'Sub: Smithing 31' },
            { 97, 'Kapor Lumber',         'Kapor Log',                      '' },
            {100, 'Vejovis Wand',         'Kapor Lumber, Black Chocobo Feather', '' },
    ...
    },
    {
        ...
        recipes = {
            ...
            { 19, 'Bronze Ingot',         'Goblin Mail / Helm',             'Mail gives x3' },
            { 20, 'Iron Ingot',           'Iron Ore',                       '' },
            { 24, 'Debahocho',            'Iron Ingot, Willow Lumber',      '' },
            { 26, 'Iron Scales',          'Iron Ore',                       '' },
            { 30, 'Iron Chain',           'Iron Ore',                       '' },
            { 36, 'Steel Sheet',          'Steel Ingot',                    '' },
            { 41, 'Iron Mittens',         'Iron materials',                 '' },
            { 47, 'Mythril Pick',         'Mythril materials',              '' },
            { 49, 'Bronze Ingot',         'Quadav Helm',                    'Old Quadav in Beadeaux 15%' },
            { 51, 'Bronze Sheet',         'Tonberry Lantern',               '' },
            { 51, 'Bronze Ingot',         'Quadav Backplate',               '' },
            ...
            { 66, 'Nodowa',               'Iron Sheet, Silk Thread',        '' },
            { 70, 'Hien',                 'Darksteel Ingot, Lizard Skin',   '' },
            ...
            { 78, 'Bronze Sheet',         'Antican Pauldron',               '' },
            { 80, 'Katzbalger',           'Broadsword, Darksteel Ingot, Raptor Skin', '' },
            { 83, 'Darksteel Nodowa',     'Darksteel materials',            '' },
            { 84, 'Thick Mufflers',       'Darksteel Mufflers, Steel Sheet', '' },
            ...
            {104, 'Bahadur',              'Adaman Ingot x4, Gold Ingot x3, Jacaranda Lumber', 'Sub: Goldsmithing 51' },
        },
    },
    {
        name     = 'Goldsmithing',
        ...
        recipes = {
            ...
            { 67, 'Hydro Patas',          'Animal Glue, Bone Patas, Mythril Sheet', '' },
            ...
            { 92, 'Muscle Belt',          'Brass Ingot, Gold Ingot, Manticore Leather', '' },
            { 95, 'Ruby Ring',            'Ruby materials',                 '' },
            { 97, 'Koenig Shield',        'Adaman Sheet, General\'s Shield, Gold Ingot, Gold Sheet', 'Sub: Smithing 58' },
            {104, 'Silver Cassandra',     'Darksteel Hexagun, Mercury, Orichalcum Ingot x2, Silver Ingot, Smilodon Leather', 'Sub: Leathercraft 39' },
        },
    },
    {
        name     = 'Clothcraft',
        ...
        recipes = {
            ...
            {  8, 'Cape',                 'Grass Thread, Grass Cloth x2',   '' },
            ...
            {100, 'Swith Cape',           'Sparkstrand, Wyrdweave x2',      '' },
            {103, 'Spolia Chapeau',       'Beeswax, Magical Cotton Cloth, Sheep Chammy, Wyrdweave x3', 'Sub: Leathercraft 50' },
        },
    },
    {
        name     = 'Leathercraft',
    ...
    },
    {
        ...
        recipes = {
            {  6, 'Tsurara',              'Distilled Water x2, Rock Salt',  '' },
            {  9, 'Cornstarch',           'Millioncorn x2',                 '' },
            { 11, 'Poison Dust',          'Giant Stinger',                  'From Bees in Wajaom Woodlands' },
            { 15, 'Poison Dust',          'Gigas Socks',                    'Gigas in Misareaux Coast' },
            { 18, 'Poison Potion',        'Poison Dust + mercury',          '' },
            { 21, 'Glass Fiber',          'Goblin Mask / Tonberry Lantern', 'Lantern caps at 23, Moblin Mask at 29'},
            { 24, 'Silent Oil',           'Beeswax x2, Slime Oil',          '' },
            { 29, 'Glass Fiber',          'Moblin Mask',                    'Can get from Venture boxes'},
            { 29, 'Yellow Textile Dye',   'Turmeric',                       '' },
            { 34, 'Artificial Lens',      'Glass Fiber x2',                 '' },
            { 40, 'Potion',               'Sage, Lizard Tail, Distilled Water', '' },
            { 45, 'Carbon Fiber',         'Bomb Ash x4',                    '' },
            { 50, 'Ether',                'Bat Wing x2, Distilled Water, Dried Marjoram, Dryad Root', '' },
            { 56, 'Cermet Chunk',         'Magic Pot Shard x4',             '' },
            { 60, 'Hi-Potion',            'Distilled Water, Malboro Vine, Sage x2', '' },
            { 61, 'Venom Dust',           'Scorpion Stinger',               '' },
            { 62, 'Glass Fiber',          'Bugbear Mask',                   '' },
            { 65, 'Chocotonic',           'Distilled Water, Gysahl Greens, Yellow Ginseng', 'Yellow Ginseng from Digging Attowha'},
            { 68, 'Venom Potion',         'Venom Dust',                     '' },
            { 71, 'Holy Maul',            'Holy Water, Maul',               'Mauls drop from Garnet Quadav' },
            { 76, 'Venom Bolt Heads',     'Animal Glue, Bronze Ingot, Venom Potion', '' },
            { 78, 'Paralyze Potion',      'Paralysis Dust + materials',     'Buy Paralysis Dust from Stinknix in Lower Jeuno' },
            { 81, 'Holy Wand',            'Holy Water, Mythic Wand',        '' },
            { 86, 'Stun Kukri',           'Animal Glue, Cermet Kukri, Paralyze Potion', '' },
            { 87, 'Holy Leather',         'Holy Water, Ram Leather',        '' },
            { 91, 'Mamushito',            'Animal Glue, Paralyze Potion, Shinobi-Gatana', '' },
            { 93, 'Icarus Wing',          'Beeswax x2, Giant Bird Feather x6', '' },
            { 97, 'Ice Shield',           'Diamond Shield, Rock Salt, Distilled Water', '' },
            { 99, 'Ephedra Ring',         'Holy Water x2, Hallowed Water, Mythril Ring', '' },
...
local SOURCES = {
    ...
    -- Smithing desynth armor
    ['Goblin Mail / Helm'] = { { type='farm', desc='Goblins in La Theine, Jugner, Pashhow, etc.' } },
    ['Quadav Helm']        = { { type='farm', desc='Old Quadav in Beadeaux (~15% drop)' } },
    ['Quadav Backplate']   = { { type='farm', desc='Quadav in Beadeaux / Qulun Dome' } },
    ['Tonberry Lantern']   = { { type='farm', desc='Tonberries in Temple of Uggalepih / Den of Rancor' } },
    ['Antican Pauldron']   = { { type='farm', desc='Anticans in E/W Altepa Desert' } },
